...
function DataTable() {
  const handleIconClick = () => {
    window.open('https://docs.google.com/document/d/1enLVDTKat4RTed2n4dFPfnGw_XCC-E9P/edit', '_blank', 'noopener,noreferrer');
  };
  ...
  return (
    <>
      ...
      <div className="dark:bg-slate-900 dark:text-white min-h-screen flex flex-col items-center py-8">
        ...
        >
          <Lightbulb size={120} className="text-yellow-300 white:text-blue-500" />
        </div>
      </div>
