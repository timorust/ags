		...
		<>
			...
			<div className='max-w-screen-2xl container mx-auto px-6 md:px-20 mb-10'>
				<div className='mt-28 items-center justify-center text-center'>
					<h1 className="text-lg md:text-xl mb-10 dark:text-white text-black break-words whitespace-normal leading-snug sm:leading-normal lg:leading-relaxed text-center max-w-full sm:max-w-3xl lg:max-w-4xl mx-auto">
						{t('AboutTitle')}<span className="text-blue-300">!</span>
					</h1>
