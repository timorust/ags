		...
		<>
			...
			<div className='max-w-screen-2xl container mx-auto px-6 md:px-20 mb-10'>
				<div className='mt-28 items-center justify-center text-center'>
					<p className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-semibold dark:text-white text-black break-words whitespace-normal leading-snug sm:leading-normal lg:leading-relaxed text-center max-w-full sm:max-w-3xl lg:max-w-4xl mx-auto">
