				...
				<div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36'>
					<div className='space-y-8'>
						...
						<label className='input input-bordered flex items-center gap-2 dark:bg-slate-900 dark:text-white'>
							...
							<input type='text' className='flex-grow outline-none border-blue-500 border-2 focus:border-blue-700 rounded-md px-2 py-1 dark:bg-slate-900 dark:text-white' placeholder='Email' />
						</label>
					</div>
