  ...
  return (
    <div className="max-w-screen-2xl container mx-auto px-6 md:px-20">
      ...
      <div className="flex justify-center mt-20 gap-6 flex-wrap">
        ...
        <div className="card w-full max-w-md bg-base-100 shadow-xl p-6 dark:bg-slate-900 dark:text-white rounded-lg">
          <figure className="flex justify-center mb-6">
            <img
              src="/avatar_2.png"
              alt="Dr. Sona IbrahImova"
              className="w-32 sm:w-40 md:w-48 lg:w-56 rounded-full border-4 border-cyan-400"
            />
          </figure>
          <div className="card-body text-center">
            <h2 className="card-title text-2xl font-semibold text-cyan-500">Dr. Sona IbrahImova PhD</h2>
            <h6 className="text-xl font-medium text-gray-400">Vice Chairman</h6>
            <p className="text-lg text-gray-500 mt-2">Zarifa Aliyeva National Eye Centre</p>
            <div className="card-actions justify-center mt-6">
              <button
                className="flex items-center gap-2 text-green-400 hover:text-green-600 active:text-green-700 transition duration-200"
                onClick={() => (window.location.href = "https://wa.me/9999999999")}  {/* עדכן עם המספר הנכון */}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
