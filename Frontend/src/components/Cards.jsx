...
const Cards = ({ item }) => {
  ...
  return (
    <div className='dark:bg-slate-900 dark:text-white dark:border card bg-base-100 w-full sm:w-1/3 md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/4 shadow-xl transform transition-transform duration-700 ease-out hover:scale-105 rounded-lg m-2'>
