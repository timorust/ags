    ...
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 
          ${sticky ? 'sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-500 transition-all ease-in-out' : ''}`}
      >
        <div className='navbar flex justify-between items-center'>
          {/* צד שמאל: לוגו ותפריט dropdown */}
          <div className='navbar-start flex items-center gap-4'>
            <div className='dropdown'>
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100/80 rounded-box w-40 dark:bg-slate-900/80 dark:text-white flex flex-col gap-3"
              >
                {navItems}
              </ul>
            </div>
          ...
          {/* צד ימין: חיפוש, מצב תאורה, התחברות */}
          <div className='navbar-end flex items-center gap-4'>
            ...
            {authUser ? (
              ...
              <div>
                <a className='bg-green-500 text-white px-3 py-2 rounded-md hover:bg-green-700 duration-500 cursor-pointer' onClick={() => document.getElementById('my_modal_3').showModal()}>
                  {t('Login')}
                </a>
                <Login />
              </div>
