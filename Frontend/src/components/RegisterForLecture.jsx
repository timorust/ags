	...
	return (
		<>
			...
			<div className="flex flex-col md:flex-row justify-center items-center md:space-x-6 mt-10">
				...
				<div className="w-full flex justify-between card mr-40 card-side bg-base-100 shadow-xl p-6 m-4 mt-20 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl dark:bg-slate-900 dark:text-white">
