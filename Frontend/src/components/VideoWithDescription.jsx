      ...
      <div className='flex flex-col md:flex-row items-center space-y-12 md:space-y-0 md:space-x-16 mb-10'>
        <div className='flex-1 md:w-1/3 text-left mb-20'>
          <div className='aspect-w-16 aspect-h-9 rounded-lg overflow-hidden shadow-xl'>
            ...
            <iframe
              className="w-full"
              src="https://www.youtube.com/embed/Ej2nGs2Wcno"
        ...
        <div className="flex-1 md:w-1/3 text-justify">
          <h3 className="font-semibold text-2xl sm:text-3xl pb-4">
            <span className="text-blue-500">{t('Our call to fight glaucoma')}</span>
          </h3>
          <ul className="mb-5 sm:mb-7 sm:text-lg text-gray-800 dark:text-white">
